...
func eventLoop(w *app.Window) error {
	go func() {
		...
		var linkBtn widget.Clickable

		/* th defines the material design style */
		th := material.NewTheme()

		/* Create an Editor widget for input */
		var numberEditor widget.Editor
			...
			case app.FrameEvent:
				...
				layout.Center.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
					return layout.Flex{
						...
						layout.Rigid(func(gtx layout.Context) layout.Dimensions {
							cb := material.CheckBox(th, &checkBoxState, "職業是否可重複")
						...
						layout.Rigid(func(gtx layout.Context) layout.Dimensions {
							return layout.Center.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
								...
								btn.Background = color.NRGBA{R: 0, G: 145, B: 147, A: 255}
